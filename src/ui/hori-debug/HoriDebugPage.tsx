 ...
 *
 * ゲーム本体の状態には触れない。GLBを読み込み、Zombie Stand Upを
 * 1回再生して停止する様子を好きな角度から確認できるようにする。
 */
    ...
    <main className={styles.page}>
      ...
      >
        ...
        <Suspense fallback={null}>
          <HoriDaisukeModel key={playToken} />
        </Suspense>
      ...
      <section className={styles.panel} aria-labelledby="hori-debug-title">
        ...
        <p>
          Zombie Stand Up を1回再生して停止します。ドラッグで視点を回し、ホイールで拡大できます。
        </p>
        <button
          type="button"
